...
trackDb_map.add_track(track_alpha_sat)
...
trackDb_map.add_track(track_rdna)
...
for genome in ["T2T-MMU8v1.0"]:
    child = bigtrack.Track(
        track=f"version_chains_{genome}",
        shortLabel=genome,
        longLabel=f"Version chain alignments to {genome}",
        type="bigChain",
...
for genome in ["Mmul_10", "T2T-MFA8v1.1", "rheMacS_1.0"]:
    child = bigtrack.Track(
        track=f"macaque_chains_{genome}",
        shortLabel=genome,
        longLabel=f"Macaque chain alignments to {genome}",
        type="bigChain",
        bigDataUrl=f"{data_dir}/liftover_chains/ref-T2T-MMU8v2.0_qry-{genome}.swapped.bigchain.bigbed",
        linkDataUrl=f"{data_dir}/liftover_chains/ref-T2T-MMU8v2.0_qry-{genome}.swapped.link.bigbed",
        visibility="pack",
...
for genome in ["T2T-CHM13v2.0", "mGorGor1_v2.0_pri", "mPanPan1_v2.0_pri", "mPanTro3_v2.0_pri", "mPonAbe1_v2.0_pri", "mPonPyg2_v2.0_pri", "mSymSyn1_v2.0_pri"]:
    child = bigtrack.Track(
        track=f"primate_chains_{genome}",
        shortLabel=genome,
        longLabel=f"Primate chain alignments to {genome}",
        type="bigChain",
        bigDataUrl=f"{data_dir}/liftover_chains/ref-T2T-MMU8v2.0_qry-{genome}.swapped.bigchain.bigbed",
        linkDataUrl=f"{data_dir}/liftover_chains/ref-T2T-MMU8v2.0_qry-{genome}.swapped.link.bigbed",
        visibility="pack",
